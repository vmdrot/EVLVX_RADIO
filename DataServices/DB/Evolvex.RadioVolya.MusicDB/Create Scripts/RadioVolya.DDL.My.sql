...
(
	tag_dttm_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	tag_id INT NOT NULL,
...
(
	tempo_id INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
(
	trck_art_id INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
(
	trck_lng_id INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
	track_id INT NOT NULL,
	lcid INT NOT NULL,
...
(
	trck_mod_id INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
	track_id INT NOT NULL,
...
(
	trck_gnr_id INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
	track_id INT NOT NULL,
...
(
	trck_tag_id INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
	track_id INT NOT NULL,
	tag_id INT NOT NULL,
...
(
	trk_pl_hist_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	track_id INT NOT NULL,
...
(
	trk_schdl_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	track_id INT NOT NULL,
	stream_id INT NOT NULL,
